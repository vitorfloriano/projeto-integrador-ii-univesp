-- Table: public.app_empresa3

-- DROP TABLE IF EXISTS public.app_empresa3;

CREATE TABLE IF NOT EXISTS public.app_empresa3
(
    ...
    CONSTRAINT app_empresa3_pkey PRIMARY KEY (id)
)
    INHERITS (public.app_geral)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS public.app_empresa3
    OWNER to postgres;